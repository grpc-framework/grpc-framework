...
| public | [ Ownership.PublicAccessControl](#ownershippublicaccesscontrol) | Public access to resource may be assigned for access by the public userd (-- api-linter: core::0140::reserved-words=disabled aip.dev/not-precedent: need to continue using the name 'public' for compatibility --) |
 <!-- end Fields -->
 <!-- end HasFields -->
